...
| [96-live-supabase-security-verification.md](completed/96-live-supabase-security-verification.md) | Medium | deployed boundary | Verified live boundary; Auth hook remediated and grant migration passes locally (production push remains manual) | GPT-5.6 Sol | M | approval/access |
