/* lonevaxling-store.ts — persistence for Löneväxling. Phase 16g commit 2: the
   ...
   Lonevaxling.tsx is untouched. supabase-js never throws — it returns
...
const CACHE_KEY = 'bostadskalkyl_lonevaxling_cache_v1'
const IMPORT_FLAG = 'bostadskalkyl_lonevaxling_supabase_imported'
const STATE = 'tool_state'
const TOOL = 'lonevaxling'
